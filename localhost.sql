...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `uid` varchar(30) NOT NULL COMMENT '유저아이디',
  `upw` varchar(128) NOT NULL COMMENT '패스워드',
  `uemail` varchar(256) NOT NULL COMMENT '유저이메일',
  `status` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '회원상태',
  PRIMARY KEY (`id`)
